...
# v0.5 - 2023-04-27: adapt the PZQ-R_GWAS_X-QTL.R to S. mansoni v10 genome
...
# Data file
myvcf_file <- paste0(data_fd, "calling/PZQ_GWAS_v10_snpEff.vcf.gz")
