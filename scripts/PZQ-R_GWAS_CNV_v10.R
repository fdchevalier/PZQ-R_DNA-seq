...
# v0.4 - 2023-04-29: adapt the PZQ-R_GWAS_CNV.R to S. mansoni v10 genome
...
for (t in exp.tag) {
    ...
    # List of BAM files
    BAMFiles <- list.files(BAMFolder, pattern = paste0(t,".*_v10.*bam$"), recursive = TRUE, full.name = TRUE)
